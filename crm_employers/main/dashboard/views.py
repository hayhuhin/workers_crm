from .serializers import GraphViewSerializer,AddRecordSerializer,UpdateRecordSerializer,DeleteRecordSerializer,CompareRecordSerializer,GetInsightsSerializer,UpdateInsightsSerializer,AddInsightsSerializer
